    ...
    <div className='w-full overflow-hidden fontclass'>
      <div className='bg-[url(https://i.imgur.com/fHdmMyl.jpg)] w-full min-h-screen overflow-hidden overflow-y-hidden bg-no-repeat bg-cover bg-center'>
          ...
          <div className='flex justify-between xs:flex xs:flex-col sm:flex-row'>
            ...
            <ul className='flex justify-around m-5 mt-8 text-[25px] font-medium xs:font-semibold sm:font-medium xl:text-[25px] xl:mt-8 xl:m-5 lg:text-[22px] md:text-[20px] xs:text-[16px] xm:text-[17px] xsl:text-[19px] sm:text-[20px] xs:mt-0 sm:mt-8 xs:justify-between'>
              <li className='mr-10 underline decoration-[#DD3B58] underline-offset-8 decoration-4 xs:ml-5 sm:ml-0'>
                ...
                <Link to='skills' spy={true} smooth={true} duration={800}>Skills</Link>
              </li>
              <li className='mr-5 underline decoration-[#DD3B58] underline-offset-8 decoration-4'>
                {/* <a href='#projects'>Projects</a> */}
                <Link to='projects' spy={true} smooth={true} duration={1000}>Work</Link>
              </li>
            </ul>
          </div>
        </nav>
        <div className='w-full mb-[280px] xl:mb-[280px] lg:mb-[250px] md:mb-[200px] sm:mb-[180px] xsl:mb-[150px] xs:mb-[130px]'>
          ...
          <a href='mailto:gprasanthchowdary@gmail.com' target='_blank'><div className='text-center mt-[30px] h-10'><button className='bg-[#DD3B58] p-2 pl-8 pr-8 rounded-full text-white font-medium text-[20px] md:text-[17px] lg:text-[18px] xs:text-[15px] border-2 bg-opacity-80 hover:bg-opacity-100 hover:border-4'>Get in Touch</button></div></a>
        </div>
      ...
      <div className='bg-[url(https://i.imgur.com/3WfWHFY.jpg)] w-full min-h-screen bg-no-repeat bg-cover bg-center'>
        <h1 className='text-white text-[40px] xl:text-[40px] lg:text-[36px] md:text-[32px] sm:text-[30px] xsl:text-[28px] xm:text-[26px] xs:text-[24px] text-center font-bold pt-10 underline decoration-[#BF3711] underline-offset-8 decoration-8 xl:decoration-8 md:decoration-[6px] sm:decoration-[5px] xsl:decoration-[4px] xs:decoration-[4px]' id='skills'>Skills</h1>
        <ul className='flex flex-wrap ml-14 mt-28 xl:mt-28 lg:mt-26 md:mt-24 sm:mt-22 xsl:mt-18 xm:mt-15 xs:mt-12 justify-center items-center font-medium xs:ml-6 xs:flex xs:flex-nowrap xs:flex-col sm:flex-row sm:flex-wrap xs:justify-center xs:items-center sm:ml-14'>
          <li className='flex text-white mr-10 mb-32 xl:mb-32 lg:mb-28 md:mb-24 sm:mb-22 xsl:mb-18 xm:mb-15 xs:mb-12'>
            ...
            <h1 className='text-[28px] xl:text-[28px] lg:text-[26px] md:text-[24px] sm:text-[23px] xsl:text-[22px] xm:text-[21px] xs:text-[20px]'>TypeScript</h1>
          </li>
          <li className='flex text-white mr-10 mb-32 xl:mb-32 lg:mb-28 md:mb-24 sm:mb-22 xsl:mb-18 xm:mb-15 xs:mb-12'>
            ...
            <h1 className='text-[28px] xl:text-[28px] lg:text-[26px] md:text-[24px] sm:text-[23px] xsl:text-[22px] xm:text-[21px] xs:text-[20px]'>ReactJS</h1>
          </li>
          <li className='flex text-white mr-10 mb-32 xl:mb-32 lg:mb-28 md:mb-24 sm:mb-22 xsl:mb-18 xm:mb-15 xs:mb-12'>
            ...
            <h1 className='text-[28px] xl:text-[28px] lg:text-[26px] md:text-[24px] sm:text-[23px] xsl:text-[22px] xm:text-[21px] xs:text-[20px]'>GraphQL</h1>
          </li>
          <li className='flex text-white mr-10 mb-32 xl:mb-32 lg:mb-28 md:mb-24 sm:mb-22 xsl:mb-18 xm:mb-15 xs:mb-12'>
            ...
            <h1 className='text-[28px] xl:text-[28px] lg:text-[26px] md:text-[24px] sm:text-[23px] xsl:text-[22px] xm:text-[21px] xs:text-[20px]'>Tailwind CSS</h1>
          </li>
          <li className='flex text-white mr-10 mb-32 xl:mb-32 lg:mb-28 md:mb-24 sm:mb-22 xsl:mb-18 xm:mb-15 xs:mb-12'>
            ...
            <h1 className='text-[28px] xl:text-[28px] lg:text-[26px] md:text-[24px] sm:text-[23px] xsl:text-[22px] xm:text-[21px] xs:text-[20px]'>Python</h1>
          </li>
          <li className='flex text-white mr-10 mb-32 xl:mb-32 lg:mb-28 md:mb-24 sm:mb-22 xsl:mb-18 xm:mb-15 xs:mb-12'>
            ...
            <h1 className='text-[28px] xl:text-[28px] lg:text-[26px] md:text-[24px] sm:text-[23px] xsl:text-[22px] xm:text-[21px] xs:text-[20px]'>NodeJS</h1>
          </li>
          <li className='flex text-white mr-10 mb-32 xl:mb-32 lg:mb-28 md:mb-24 sm:mb-22 xsl:mb-18 xm:mb-15 xs:mb-12'>
            ...
            <h1 className='text-[28px] xl:text-[28px] lg:text-[26px] md:text-[24px] sm:text-[23px] xsl:text-[22px] xm:text-[21px] xs:text-[20px]'>ExpressJS</h1>
          </li>
          <li className='flex text-white mr-10 mb-32 xl:mb-32 lg:mb-28 md:mb-24 sm:mb-22 xsl:mb-18 xm:mb-15 xs:mb-12'>
            ...
            <h1 className='text-[28px] xl:text-[28px] lg:text-[26px] md:text-[24px] sm:text-[23px] xsl:text-[22px] xm:text-[21px] xs:text-[20px]'>JavaScript</h1>
          </li>
          <li className='flex text-white mr-10 mb-32 xl:mb-32 lg:mb-28 md:mb-24 sm:mb-22 xsl:mb-18 xm:mb-15 xs:mb-12'>
            ...
            <h1 className='text-[28px] xl:text-[28px] lg:text-[26px] md:text-[24px] sm:text-[23px] xsl:text-[22px] xm:text-[21px] xs:text-[20px]'>SQLite</h1>
          </li>
          <li className='flex text-white mr-10 mb-32 xl:mb-32 lg:mb-28 md:mb-24 sm:mb-22 xsl:mb-18 xm:mb-15 xs:mb-12'>
            ...
            <h1 className='text-[28px] xl:text-[28px] lg:text-[26px] md:text-[24px] sm:text-[23px] xsl:text-[22px] xm:text-[21px] xs:text-[20px]'>MongoDB</h1>
          </li>
          <li className='flex text-white mr-10 mb-32 xl:mb-32 lg:mb-28 md:mb-24 sm:mb-22 xsl:mb-18 xm:mb-15 xs:mb-12'>
            ...
            <h1 className='text-[28px] xl:text-[28px] lg:text-[26px] md:text-[24px] sm:text-[23px] xsl:text-[22px] xm:text-[21px] xs:text-[20px]'>Ant Design</h1>
          </li>
          <li className='flex text-white mr-10 mb-32 xl:mb-32 lg:mb-28 md:mb-24 sm:mb-22 xsl:mb-18 xm:mb-15 xs:mb-12'>
            ...
            <h1 className='text-[28px] xl:text-[28px] lg:text-[26px] md:text-[24px] sm:text-[23px] xsl:text-[22px] xm:text-[21px] xs:text-[20px]'>BootStrap</h1>
          </li>
          <li className='flex text-white mr-10 mb-32 xl:mb-32 lg:mb-28 md:mb-24 sm:mb-22 xsl:mb-18 xm:mb-15 xs:mb-12'>
            ...
            <h1 className='text-[28px] xl:text-[28px] lg:text-[26px] md:text-[24px] sm:text-[23px] xsl:text-[22px] xm:text-[21px] xs:text-[20px]'>ContentFul</h1>
          </li>
          <li className='flex text-white mr-10 mb-32 xl:mb-32 lg:mb-28 md:mb-24 sm:mb-22 xsl:mb-18 xm:mb-15 xs:mb-12'>
            ...
            <h1 className='text-[28px] xl:text-[28px] lg:text-[26px] md:text-[24px] sm:text-[23px] xsl:text-[22px] xm:text-[21px] xs:text-[20px]'>HTML</h1>
          </li>
          <li className='flex text-white mr-10 mb-32 xl:mb-32 lg:mb-28 md:mb-24 sm:mb-22 xsl:mb-18 xm:mb-15 xs:mb-12'>
            ...
            <h1 className='text-[28px] xl:text-[28px] lg:text-[26px] md:text-[24px] sm:text-[23px] xsl:text-[22px] xm:text-[21px] xs:text-[20px]'>CSS/FlexBox</h1>
          </li>
          <li className='flex text-white mr-10 mb-32 xl:mb-32 lg:mb-28 md:mb-24 sm:mb-22 xsl:mb-18 xm:mb-15 xs:mb-12'>
      ...
      <h1 className='text-white text-[40px] xl:text-[40px] lg:text-[36px] md:text-[32px] sm:text-[30px] xsl:text-[28px] xm:text-[26px] xs:text-[25px] text-center font-bold pt-5 underline decoration-[#E93438] underline-offset-8 decoration-8 xl:decoration-8 md:decoration-[6px] xs:decoration-[4px]' id="projects">Work Experience</h1>
      <h1 className='text-white text-[30px] xl:text-[30px] lg:text-[28px] md:text-[26px] sm:text-[24px] xsl:text-[22px] xm:text-[20px] xs:text-[19px] font-medium pt-8 ml-10 xs:ml-0 xs:text-center sm:text-left sm:ml-10 underline decoration-[#E93438] underline-offset-8 decoration-4'>salesBeat : June 2022 - Present</h1>
      <div>
        <div className='text-white bg-[#E93438] rounded-2xl mt-5 ml-5 w-[60%] xl:w-[60%] lg:w-[68%] md:w-[75%] xs:w-[90%] font-medium p-5 pt-3 bg-opacity-50'>
          <div className='flex'>
          <h1 className='text-[25px] xl:text-[25px] lg:text-[23px] md:text-[20px] sm:text-[19px] xsl:text-[18px] xs:text-[17px] mb-3 underline decoration-[#E93438] underline-offset-8 decoration-4'>salesBeat SaaS Platform   - </h1><a href='https://i.imgur.com/XstQNWN.png' target="_blank"><AiFillEye className='h-6 w-6 mt-2 ml-2 xs:mt-1 xsl:mt-1 sm:mt-1 md:mt-1 lg:mt-1.5 xl:mt-2 xs:h-5 xs:w-5 sm:h-6 sm:w-6'/></a></div>
          <p className='text-[20px] xl:text-[20px] lg:text-[19px] md:text-[18px] sm:text-[17px] xsl:text-[16px] xs:text-[15px] mb-4'>Purpose: Demand Planning and Market Insights for Retail Chains & Brands</p>
          <div className='flex xs:flex-col xsl:flex-row'>
          <div className='flex flex-col mr-20'>
          <p className='text-[20px] xl:text-[20px] lg:text-[19px] md:text-[18px] sm:text-[17px] xsl:text-[16px] xs:text-[15px] mb-2 underline decoration-[#E93438] underline-offset-8 decoration-4'>My Contributions:</p>
          ...
          <p className='text-[20px] xl:text-[20px] lg:text-[19px] md:text-[18px] sm:text-[17px] xsl:text-[16px] xs:text-[15px] mb-2 underline decoration-[#E93438] underline-offset-8 decoration-4'>Built using: </p>
          <ul className='text-[18px] xl:text-[18px] lg:text-[17px] md:text-[16px] sm:text-[15px] xsl:text-[14px] xs:text-[13px] list-disc pl-5 mb-2'>
        ...
        <div className='text-white bg-[#E93438] rounded-2xl mt-5 ml-5 w-[60%] xl:w-[60%] lg:w-[68%] md:w-[75%] xs:w-[90%] font-medium p-5 pt-3 bg-opacity-50'>
          <div className='flex'>
          <h1 className='text-[25px] xl:text-[25px] lg:text-[23px] md:text-[20px] sm:text-[19px] xsl:text-[18px] xs:text-[17px] mb-3 underline decoration-[#E93438] underline-offset-8 decoration-4'>salesBeat Site</h1><a href='https://salesbeat.co/' target='_blank'><BsArrowUpRight className='h-5 w-5 mt-2.5 ml-2 xs:mt-1 xsl:mt-1 sm:mt-1 md:mt-1.5 lg:mt-2 xl:mt-2.5'/></a></div>
          <p className='text-[20px] xl:text-[20px] lg:text-[19px] md:text-[18px] sm:text-[17px] xsl:text-[16px] xs:text-[15px] mb-2 underline decoration-[#E93438] underline-offset-8 decoration-4'>My Contributions:</p>
      ...
      <div className='bg-[url(https://i.imgur.com/9IZUHtl.jpg)] w-full min-h-screen flex justify-center items-center bg-no-repeat bg-cover bg-center'>
        ...
        <h1 className='text-white text-[40px] xl:text-[40px] lg:text-[35px] md:text-[30px] sm:text-[28px] xsl:text-[25px] xs:text-[23px] text-center font-medium'>Inspired from the StarWars Binary Sunset</h1>
        <img src='https://media.discordapp.net/attachments/990816866618470440/1074205369682907166/301803637_506902801440735_987699678916294777_n-removebg-preview.png' className='w-10 h-10 mt-[2px] ml-2 xl:mt-[2px]'/>
        </div>
      </div>
    </div>
  )
